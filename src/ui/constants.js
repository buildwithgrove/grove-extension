 ...
 * Placeholders: {username}, {amount}, {chain}, {tx_link}, {post_url}, {referral_link}
 */
var DEFAULT_AUTO_REPLY_MESSAGE = `Hey @{username}, I enjoyed your post {post_url} so I tipped you ~{amount} on {chain} via @BuildWithGrove!
