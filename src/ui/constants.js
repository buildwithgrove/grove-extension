 ...
 * Placeholders: {username}, {amount}, {chain}, {tx_link}, {tweet_url}, {referral_link}
 */
var DEFAULT_AUTO_REPLY_MESSAGE = `Hey @{username}, I enjoyed your post {tweet_url} so I tipped you ~{amount} on {chain} via @BuildWithGrove!
