...
var STORAGE_KEYS = {
  ...
  EARNING_ADDRESS: "GROVE_EARNING_ADDRESS", // User's earning wallet (Smart Account)
  TIPPING_ADDRESS: "GROVE_TIPPING_ADDRESS", // Grove-managed tipping wallet (Server)
  SMART_ACCOUNT_ADDRESS: "GROVE_SMART_ACCOUNT_ADDRESS", // ERC-4337 smart account (matches EARNING)
  EXTERNAL_LINKED_WALLETS: "GROVE_EXTERNAL_LINKED_WALLETS", // Linked profile wallets
  ENS_NAME: "GROVE_ENS_NAME",

  // Migration flags
  WALLET_KEYS_MIGRATED: "GROVE_WALLET_KEYS_MIGRATED",
